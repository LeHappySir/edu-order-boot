...
import com.lagou.edu.course.client.dto.ActivityCourseUpdateStockDTO;
import com.lagou.edu.course.client.dto.CourseDTO;
import com.lagou.edu.course.client.enums.CourseStatus;
...
public class UserCourseOrderServiceImpl extends ServiceImpl<UserCourseOrderMapper, UserCourseOrder> implements IUserCourseOrderService {
	...
	*/
	...
	public UserCourseOrderDTO getCourseOrderByOrderNo(String orderNo) {
		...
		return CoverUtil.cover(userCourseOrderDB, UserCourseOrderDTO.class);
	}
    ...
    */
	...
	public List<UserCourseOrderDTO> getUserCourseOrderByUserId(Integer userId) {
		...
		return CoverUtil.coverList(userCourseOrderList, UserCourseOrderDTO.class);
	}
